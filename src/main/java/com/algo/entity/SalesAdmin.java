...
public class SalesAdmin extends DomainObject {
	@Id
	@GeneratedValue(generator = "Sales_gen", strategy = GenerationType.IDENTITY)
	@GenericGenerator(name = "Sales_gen", strategy = "com.algo.config.DistributerIdGenerator", parameters = @org.hibernate.annotations.Parameter(name = "type", value = "String"))
